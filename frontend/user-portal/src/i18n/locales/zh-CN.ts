...
export default {
  ...
  mainTableView: {
    ...
    dashboardMode: '仪表盘',
    displayMode: '显示模式',
    noAssignedDashboard: '该表暂未绑定仪表盘。',
    loadDashboardsFailed: '加载该视图绑定的仪表盘失败',
    dashboardLoadFailed: '仪表盘加载失败，请稍后重试。',
    functionUnits: '功能单元',
  ...
  sharedList: {
    ...
    filterValue: '值',
    filterValueTo: '至',
    filterValuePlaceholder: '请输入值',
    filterUserPlaceholder: '按姓名或工号搜索',
    clear: '清除',
    confirm: '应用',
    opContains: '包含',
    opNotContains: '不包含',
  ...
  dashboard: {
    ...
    refresh: '刷新',
    updatedAt: '更新于 {time}',
    loadFailed: '首页数据没能加载，下面这些数字不是你的真实情况。',
    retry: '重试',
    introClear: '{date}，当前没有等你决定的事。',
    introPending: '{date}，有 {count} 项任务在等你。',
    colRequest: '所属申请',
    myRequests: '我的申请',
    myTeam: '我的团队',
    tasks: '任务',
    claimableTasks: '可认领',
    todoTasks: '待办',
    openClaimableTasks: '打开认领队列',
    openTodoTasks: '打开待办',
    openCompletedTasks: '打开已处理任务',
    recentRequests: '我最近的申请',
    noRequests: '你还没有发起过申请。',
    needsAction: '需要你处理',
  ...
  task: {
    ...
    heldByOther: '已被认领',
    claimAll: '一键认领',
    claimAllConfirm: '认领当前所有你可以认领的请求？队列较大时会自动分批处理。',
    claimAllEmpty: '当前没有可认领的请求',
    claimAllDone: '已认领 {claimed} 条。跳过 {skipped} 条。失败 {failed} 条。',
    unclaimAll: '一键取消认领',
    unclaimAllConfirm: '释放你当前持有的全部角色请求？不会释放同事的持有。',
    unclaimAllEmpty: '你当前没有持有角色请求',
    unclaimAllDone: '已释放 {claimed} 条。跳过 {skipped} 条。失败 {failed} 条。',
    claimSelectedConfirm: '认领已选 {selected} 条中的 {eligible} 条可认领任务？',
    unclaimSelectedConfirm: '释放已选 {selected} 条中你持有的 {eligible} 条？',
    claimSelectedEmpty: '选中的任务里没有可认领的',
    unclaimSelectedEmpty: '选中的任务里没有你持有的',
    autoClaimOnOpen: '打开时自动认领',
    autoClaimOnOpenHint: '开启后，从待办打开空闲角色请求会先认领。首页、通知和已处理任务不会自动认领。默认关闭。',
    autoPreviewOnOpen: '打开时自动预览',
    autoPreviewOnOpenHint: '开启后，打开任务或申请表单会弹出第一个可预览文件。默认关闭。备注附件不计入。',
    claimSuccess: '认领成功',
    unclaimSuccess: '已取消认领',
    forceUnclaim: '强制释放',
    forceUnclaimConfirm: '确定释放 {user} 持有的请求？释放后同角色其他成员可以重新认领。',
    forceUnclaimSuccess: '已强制释放',
    forceUnclaimHint: '你可以强制释放该持有，让同角色其他成员重新认领。',
    reassign: '重新分配',
    reassignTo: '分配给',
    reassignHint: '你可以把该请求指定给同一角色的其他成员。',
    reassignSuccess: '已重新分配',
    reassignNoCandidates: '该角色没有其他可分配的成员。',
    reassignConfirm: '将该请求分配给所选用户？若已被他人持有，将覆盖其持有。',
    claimAvailable: '该请求尚未被认领',
    claimAvailableHint: '认领后锁定到你名下即可编辑。',
    claimHeldByYou: '你已认领该请求',
    claimHeldByYouHint: '取消认领后，同角色的其他成员可重新认领。',
    claimHeldByOther: '已被 {user} 认领',
    claimHeldByOtherHint: '在认领人释放前仅可查看。',
    completedTasks: '已处理任务',
    completedTime: '完成时间',
    taskName: '任务名称',
    currentStep: '当前步骤',
    ...
    delegationStatus: '委托',
    delegateTargetType: '委托给',
    delegateSpecifyUser: '指定用户',
    delegateSpecifyBuRole: '指定 BU 和 Role',
    delegateBusinessUnit: '业务单元',
    delegateRole: '角色',
  ...
  application: {
    ...
    startTime: '发起时间',
    status: '状态',
    running: applicationStatusLabels.RUNNING['zh-CN'],
    completed: applicationStatusLabels.COMPLETED['zh-CN'],
    withdrawn: applicationStatusLabels.WITHDRAWN['zh-CN'],
    rejected: applicationStatusLabels.REJECTED['zh-CN'],
    draft: '草稿',
    draftBox: '草稿箱',
    withdraw: '撤回',
    urge: '催办',
  ...
  permission: {
    ...
    member: '成员',
    leader: 'Leader',
    membershipType: '成员 / Leader',
    membershipHint:
      '成员可以认领和取消认领自己持有的请求。Leader 还可以强制释放同角色其他人持有的请求，或将其重新分配给同一角色的其他成员。',
    applyLeaderGuideLinkAria: '打开成员与 Leader 指南',
    applyType: '申请类型',
    applyRole: '申请角色',
  ...
  upload: {
    ...
    descriptionSaveSuccess: '文件描述已保存',
    preview: '预览',
    guideLinkAria: '打开文件详情说明',
  ...
  filePreview: {
    ...
    zoomFit: '适应窗口',
    zoomPercent: '{n}%',
    zoomWheelHint: '按住 Ctrl 并滚动滚轮，以指针位置为中心缩放',
    pageTitle: '文件预览',
    empty: '没有可预览的文件。请从表单打开一个文件。',
    guideLinkAria: '打开文件预览指南',
  },
  login: {
    title: '工作流平台',
    subtitle: '用户门户',
