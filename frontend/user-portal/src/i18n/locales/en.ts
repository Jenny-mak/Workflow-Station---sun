export default {
  ...
  mainTableView: {
    ...
    filterPickDate: 'Select date',
    filterDateStart: 'Start date',
    filterDateEnd: 'End date',
    filterPickValue: 'Select value',
  ...
  processStart: {
    ...
    firstStepIncomplete:
      'Request created, but its first step did not complete. It is waiting in your Pending Tasks — open it and submit again. If it keeps failing, contact your administrator.',
  ...
  delegation: {
    ...
    selectProcessTypes: 'Select process types',
    processTypesRequired: 'Partial delegation requires at least one process type',
    temporaryTimeRequired: 'Temporary delegation requires start and end time',
    invalidTimeRange: 'Delegation end time must be after start time',
