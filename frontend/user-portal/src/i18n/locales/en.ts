...
export default {
  ...
  delegation: {
    ...
    result: 'Result',
    time: 'Time',
    noProxyTasks: 'No delegated tasks',
    selectDelegate: 'Please select delegate',
    cannotDelegateSelf: 'You cannot delegate to yourself',
    specifyUser: 'Specified user',
    specifyBuRole: 'Specified BU and Role',
    targetType: 'Delegate to',
    targetBuRole: '{bu} / {role}',
    processTypesPlaceholder: 'Select function units',
    buRolePairRequired: 'Please select both business unit and role',
