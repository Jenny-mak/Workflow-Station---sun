...
export default {
  ...
  mainTableView: {
    ...
    noAssignedDashboard: 'No dashboard is assigned to this table.',
    loadDashboardsFailed: 'Failed to load dashboards assigned to this view',
    dashboardLoadFailed: 'Failed to load dashboard. Please try again later.',
  ...
  sharedList: {
    sortAsc: 'A to Z',
    sortDesc: 'Z to A',
    sortOlder: 'Older to newer',
    sortNewer: 'Newer to older',
    ...
    filterUserPlaceholder: 'Search by name or staff ID',
    clear: 'Clear',
    confirm: 'Apply',
    opContains: 'Contains',
    ...
    opLast30days: 'Last 30 days',
    opThisWeek: 'This week',
    opThisMonth: 'This month',
    opThisYear: 'This year',
    opOn: 'On',
    opBefore: 'Before',
    opAfter: 'After',
    opBetween: 'Between',
  ...
  dashboard: {
    ...
    loadFailed: 'We could not load your home page, so these numbers are not yours.',
    retry: 'Try again',
    introClear: '{date}. Nothing needs your decision right now.',
    introPending: '{date}. 1 task is waiting for you. | {date}. {count} tasks are waiting for you.',
    colRequest: 'Request',
    myRequests: 'My requests',
    myTeam: 'My team',
    tasks: 'Tasks',
    ...
    todoTasks: 'To Do',
    openClaimableTasks: 'Open claim queue',
    openTodoTasks: 'Open To Do',
    openCompletedTasks: 'Open completed tasks',
    recentRequests: 'My recent requests',
    noRequests: 'You have not started a request yet.',
  ...
  task: {
    ...
    heldByOther: 'Held',
    claimAll: 'Claim all',
    claimAllConfirm: 'Claim every request that is free for you now? This may take several batches if the queue is large.',
    claimAllEmpty: 'There is nothing free to claim',
    claimAllDone: 'Claimed {claimed}. Skipped {skipped}. Failed {failed}.',
    unclaimAll: 'Unclaim all',
    unclaimAllConfirm: 'Release every role request you currently hold? This does not release a colleague’s hold.',
    unclaimAllEmpty: 'You are not holding any role request',
    unclaimAllDone: 'Released {claimed}. Skipped {skipped}. Failed {failed}.',
    claimSelectedConfirm: 'Claim {eligible} of {selected} selected tasks?',
    unclaimSelectedConfirm: 'Unclaim {eligible} of {selected} selected tasks you hold?',
    claimSelectedEmpty: 'None of the selected tasks can be claimed',
    unclaimSelectedEmpty: 'None of the selected tasks are held by you',
    autoClaimOnOpen: 'Auto-claim on open',
    autoClaimOnOpenHint: 'When on, opening a free role request from To Do claims it first. Home, notifications, and Completed Tasks do not auto-claim. Default off.',
    autoPreviewOnOpen: 'Auto-preview on open',
    autoPreviewOnOpenHint: 'When on, opening a task or request form opens the first previewable file. Default off. Notes are not included.',
    claimSuccess: 'Task claimed',
    unclaimSuccess: 'Task released',
    forceUnclaim: 'Force Unclaim',
    forceUnclaimConfirm: 'Release the hold by {user}? Other members of this role can then Claim it.',
    forceUnclaimSuccess: 'Hold released',
    forceUnclaimHint: 'You can force-release this hold so another member of the role can Claim it.',
    reassign: 'Reassign',
    reassignTo: 'Assign to',
    reassignHint: 'You can assign this request to another member of the same role.',
    reassignSuccess: 'Request reassigned',
    reassignNoCandidates: 'No other member of this role is available.',
    reassignConfirm: 'Assign this request to the selected user? If someone else holds it, their hold is replaced.',
    claimAvailable: 'This request is not claimed yet',
    claimAvailableHint: 'Claim it to hold the request and start editing.',
    claimHeldByYou: 'You are holding this request',
    claimHeldByYouHint: 'Release it to let another member of your role pick it up.',
    claimHeldByOther: 'Claimed by {user}',
    claimHeldByOtherHint: 'View only until the holder releases this request.',
    completedTasks: 'Completed Tasks',
    ...
    complete: 'Complete',
    delegate: 'Delegate',
    guideLinkAria: 'Open task-delegate guidelines',
    transfer: 'Transfer',
    urge: 'Urge',
    ...
    delegateTargetType: 'Delegate to',
    delegateSpecifyUser: 'Specified user',
    delegateSpecifyBuRole: 'Specified BU and Role',
    delegateBusinessUnit: 'Business Unit',
    delegateRole: 'Role',
  ...
  permission: {
    ...
    member: 'Member',
    leader: 'Leader',
    membershipType: 'Member / Leader',
    membershipHint:
      'Member can Claim and Unclaim their own holds. Leader can also force-release a hold taken by someone else in this role, or Reassign it to another member of the same role.',
    applyLeaderGuideLinkAria: 'Open Member and Leader guideline',
  ...
  upload: {
    ...
    descriptionSaveSuccess: 'File description saved',
    preview: 'Preview',
    guideLinkAria: 'Open upload file details guidelines',
  ...
  filePreview: {
    ...
    nextFile: 'Next file',
    fileOf: '{current} of {total}',
    zoomIn: 'Zoom in',
    zoomOut: 'Zoom out',
    zoomActual: '100%',
    zoomFit: 'Fit',
    zoomPercent: '{n}%',
    zoomWheelHint: 'Ctrl + scroll to zoom at the cursor',
    pageTitle: 'File preview',
    empty: 'No file to preview. Open a file from the form.',
    guideLinkAria: 'Open file preview guideline',
  },
  user: {
    username: 'Username',
    email: 'Email'
  ...
  recordNote: {
    ...
    edited: '(edited)',
    saveFirst: 'Notes become available after the record is saved',
    deleteConfirm: 'Delete this note? Its attachments will be removed as well.',
...
exportWithData: 'Export',
    ...
    assignmentMissingRowKey: 'Cannot assign: this row has no primary key. Please contact an administrator to check the table\'s primary key configuration.',
    taskStatus: 'Status',
    taskPending: 'Pending',
  ...
  changeHistory: {
    ...
    recordNoteAdd: 'Note Added',
    recordNoteUpdate: 'Note Edited',
    recordNoteDelete: 'Note Deleted',
